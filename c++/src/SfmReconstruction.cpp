...
bool SfmReconstruction::run_sfm_reconstruction(bool downscale) {
    ...
    //    image_pair, this->images_features[image_pair.left],
...
/*     stereo_util.triangulate_views(image_pair, pruned_matches_E,
 * features_left, */
...
/**/
/*         if (!success) { */
/*             std::cout << "Error: Cannot recover camera pose from view: " */
/*                       << best_view << std::endl; */
/*             continue; */
/*         } */
/**/
 ...
 */
/*                                   pruned_matches_F); */
/*             std::cout << "No. Matches after F mask: " <<
 * pruned_matches_F.size() */
/*                       << std::endl */
/*                       << std::endl; */
/**/
/*             // std::vector<cv::DMatch> pruned_matches_H; */
/*             // stereo_util.compute_homography(features_left, features_right,
 */
/*             // matches, */
/*             //                                pruned_matches_H); */
/*             // std::cout << "No. Matches after H mask: " << */
/*             // pruned_matches_H.size() */
/*             //           << std::endl */
/*             //           << std::endl; */
/**/
/*             // Compute the Essential Matrix */
...
/*             cv::Mat E; */
/*             std::vector<cv::DMatch> pruned_matches_E; */
/*             stereo_util.compute_E(features_left, features_right, */
/*                                   pruned_matches_F, this->intrinsics, E, */
/*                                   pruned_matches_E); */
/*             std::cout << "No. Matches after E mask: " <<
 * pruned_matches_E.size() */
/*                       << std::endl */
/*                       << std::endl; */
/**/
/*             this->match_matrix[left_view_idx][right_view_idx] = */
...
/*             // Compute the Rotation and translation */
/*             cv::Mat R, t; */
/*             stereo_util.compute_Rt(features_left, features_right, */
/*                                    pruned_matches_E, this->intrinsics, E, R,
 * t); */
/**/
/*             // Compute Projection Matrices */
/*             cv::Matx34f P_left, P_right; */
...
/**/
/*                 // left index < right index (the match matrix is upper */
/*                 // triangular, i < j) */
/*                 //   | a00 a01 a02 a03| */
/*                 //   |  0  a11 a12 a13| */
/*                 //   |  0   0  a22 a23| */
/*                 //   |  0   0   0  a33| */
/*                 int left_view_idx = */
/*                     (origin_view_idx < view_idx) ? origin_view_idx :
 * view_idx; */
/*                 int right_view_idx = */
/*                     (origin_view_idx < view_idx) ? view_idx :
 * origin_view_idx; */
/**/
/*                 // scan all 2D - 2D matches between the new view and the
 * origin */
/*                 // view */
